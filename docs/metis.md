...
Metis implements FP4/FP8 quantization strategies through simulation. The implementation details can be found in `src/Metis/Metis/quant.py`.

The implementation details of Metis can be found in `src/Metis/Metis/bitlinear.py`.
...
# fp4e2m1(b) fp4 quantization scheme, currently NVFP4 scheme. To change, modify in src/Metis/Metis/quant.py
...
--backward-longtail-schedule ysche # Specify the scheduling scheme for Adaptive lr.
                                   # You can define your own scheme in src/Metis/Metis/bitlinear.py
```
...
from Metis.Metis.bitlinear import *
