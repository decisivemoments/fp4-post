# Qwen2.5-Math-7B-Instruct: large-model run. Uses CPU optimizer offload by default.

export DEEPSPEED_CONFIG="${DEEPSPEED_CONFIG:-configs/grpo/ds_config_zero2_qwen2_5_math_7b.json}"
