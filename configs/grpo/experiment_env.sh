...
export METIS_HADAMARD_BACKEND="${METIS_HADAMARD_BACKEND:-auto}"
export METIS_HADAMARD_TILE_SIZE="${METIS_HADAMARD_TILE_SIZE:-16}"
export METIS_HADAMARD_WORKSPACE_MB="${METIS_HADAMARD_WORKSPACE_MB:-128}"
