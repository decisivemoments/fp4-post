...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[stage=bfblue, minimum width=112mm, minimum height=30mm, anchor=west] (qatbox) at (3.0,5.85) {};
  ...
  \node[font=\scriptsize] at (8.80,4.84) {$\mathcal{L}_{\mathrm{KD}}=T^2\!\sum_{t\in y}\mathrm{KL}(p_T\Vert p_S)$};
